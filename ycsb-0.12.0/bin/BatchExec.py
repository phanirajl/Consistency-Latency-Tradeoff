...
operationcount = ["1000000","10000","100"]
				...
				print paramValue
                                ...
                                while True:
                                        try:
                                                ...
                                                session.execute('create table usertable ( y_id varchar primary key, field0 varchar) WITH dclocal_read_repair_chance = ' + str(chance[0]) + " AND read_repair_chance = " + str(chance[1]) + ' AND speculative_retry = \'NONE\';', None)
