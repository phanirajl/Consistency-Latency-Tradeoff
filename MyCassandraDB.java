...
public class MyCassandraDB extends DB {
        ...
        try {
          ...
          if (host == null) {
            ...
            if (username != null && !username.isEmpty()) {
              cluster = Cluster.builder().withCredentials(username, password).withPort(Integer.valueOf(port).intValue()).addContactPoints(hosts).withLoadBalancingPolicy(new RoundRobinPolicy()).build();
            } else {
              cluster = Cluster.builder().withPort(Integer.valueOf(port).intValue()).addContactPoints(hosts).withLoadBalancingPolicy(new RoundRobinPolicy()).build();
            }
